...
import { Prayer, PrayerStatus, User, QadaStats, PrayerPartner, RakibGroup, Surah, Ayah } from './types';
...
/**
 * @deprecated - DO NOT USE. This is legacy mock data.
 * User data should come from LocalStorageService or Firebase Auth.
 */
...
export const INITIAL_PRAYERS: Prayer[] = [
  { id: "fajr", name: "Fajr", arabicName: "الفجر", time: "04:27", status: PrayerStatus.Upcoming },
  { id: "dhuhr", name: "Dhuhr", arabicName: "الظهر", time: "12:41", status: PrayerStatus.Upcoming },
  { id: "asr", name: "Asr", arabicName: "العصر", time: "15:13", status: PrayerStatus.Upcoming },
  { id: "maghrib", name: "Maghrib", arabicName: "المغرب", time: "18:05", status: PrayerStatus.Upcoming },
  { id: "isha", name: "Isha", arabicName: "العشاء", time: "19:30", status: PrayerStatus.Upcoming, isNext: true },
];

/**
 * @deprecated - DO NOT USE. This is legacy mock data.
 * Qada stats should come from LocalStorageService or Firebase.
 */
...
export const STATUS_COLORS = {
  ...
  [PrayerStatus.Upcoming]: 'bg-brand-primary/5 text-brand-primary',
};
...
// --- DEPRECATED MOCK RAKIB DATA - DO NOT USE IN PRODUCTION ---

/**
 * @deprecated - DO NOT USE. Real partners come from PartnerService via Firebase.
 */
export const MOCK_PARTNERS: PrayerPartner[] = [];

/**
 * @deprecated - DO NOT USE. Groups feature not yet implemented.
 */
