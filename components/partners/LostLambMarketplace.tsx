...
export const LostLambMarketplace: React.FC = () => {
    ...
    const handleConnect = async (profileId: string) => {
        ...
        if (!myProfile) {
            alert("Your profile is being set up. Please try again in a moment.");
    ...
    return (
        <div className="space-y-6 pt-4">
            ...
            {/* Header / My Status */}
            <div className="glass-panel p-6 bg-brand-surface/80">
                ...
                <div className="flex items-center justify-between mt-5 p-4 bg-brand-surface/80 backdrop-blur-md rounded-2xl shadow-sm border border-brand-border transition-all hover:shadow-md">
                    ...
                    <button
                        ...
                        className={`w-14 h-8 rounded-full transition-all duration-300 relative focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-primary ${nearbyOnly ? 'bg-brand-primary shadow-lg shadow-brand-primary/30' : 'bg-brand-border'}`}
                    >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        {profiles.map(profile => (
                            <motion.div
                                ...
                                animate={{ opacity: 1, y: 0 }}
                                whileHover={{ y: -5 }}
                                className="bg-brand-surface rounded-2xl shadow-sm hover:shadow-xl border border-brand-border overflow-hidden transition-all duration-300 group relative"
                            >
                                ...
                                <div className="p-6">
                                    ...
                                    <button
                                        ...
                                        className="btn btn-secondary w-full group-hover:border-brand-primary"
                                    >
                                        <User size={18} />
                                        <span>Connect</span>
                                    </button>
