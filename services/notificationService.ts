...
class NotificationService {
    ...
    subscribeToNotifications(
        ...
        // Poll immediately, then every 30 seconds (optimized from real-time)
        pollNotifications();
    ...
    private getNotificationTitle(type: string): string {
        switch (type) {
            case 'adhan_reminder': return '🕌 Prayer Reminder';
            case 'reminder': return '⏰ Partner Reminder';
            case 'broadcast': return '📢 Circle Broadcast';
