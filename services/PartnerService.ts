...
export const PartnerService = {
    ...
    // --- Adhan Reminders ---
    async sendAdhanReminder(senderId: string, recipientId: string, prayerName: string) {
        try {
            await addDoc(collection(db, 'notifications'), {
                ...
                prayerName,
                message: `Time for ${prayerName} prayer! Your partner is waiting.`,
    ...
    async searchPublicProfiles(filters: {
        ...
        // Get all active partnerships to filter out partnered users
        ...
        // Exclude partnered users from results
